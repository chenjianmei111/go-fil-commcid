...
1. Look through the [issues for this repo](https://github.com/chenjianmei111/go-fil-commcid/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/chenjianmei111/go-fil-commcid/pulls) to see how others do it.
...
import (
	...
	"github.com/chenjianmei111/go-fil-commcid/filestore/file"
)
```
